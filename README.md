# 🚀 Juzer Tezabwala | Power BI Data Analyst & Python Developer

<div align="center">

[![Power BI](https://img.shields.io/badge/Power_BI-Dashboards-F2C811?style=for-the-badge&logo=powerbi&logoColor=black)](https://powerbi.microsoft.com/)
...
**A portfolio showcasing interactive Power BI Business Intelligence dashboards, full-stack Python systems, automation utilities, and data structures.**

[Explore Projects](#-featured-projects) • [Repository Structure](#-repository-structure) • [Quick Start](#-quick-start) • [Contact](#-connect--contact)
...
| **Data Structures** | [Stacks & Queues](./02_Python_Projects_and_Systems/data_structures_stacks_and_queues/) | `Python OOP`, `Data Structures` | Implemented linear LIFO Stacks, FIFO Queues, and ring-buffer Circular Queues with overflow/underflow handling. |
| **Visualization** | [Python Data Visualizations](./02_Python_Projects_and_Systems/data_visualization/) | `Matplotlib`, `NumPy` | Mathematical IQR outlier detection, boxplot distributions, and multi-axes function plotting. |
...
| **Databases** | SQLite, pyodbc, Relational Schema Design, ACID Transactions |
| **Tools & Utilities** | Git/GitHub, Jupyter Notebooks, VS Code, Web Scraping (yt-dlp, BeautifulSoup, APIs) |
...
```bash
git clone git@github.com:juzertezabwala58/portfolio.git
cd portfolio
```
...
### 3. Run the Projects
```bash
# Launch the Interactive Banking Management System
python 02_Python_Projects_and_Systems/banking_management_system/main.py

# Run Stack & Queue Demo
python 02_Python_Projects_and_Systems/data_structures_stacks_and_queues/stack_and_queue.py
```
...
- **GitHub**: [@juzertezabwala58](https://github.com/juzertezabwala58)
- **Repository**: [github.com/juzertezabwala58/portfolio](https://github.com/juzertezabwala58/portfolio)

---

<div align="center">
⭐ <i>If you find these projects interesting or helpful, feel free to star the repository!</i>
</div>
